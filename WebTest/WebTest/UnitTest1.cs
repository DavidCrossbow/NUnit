...
namespace WebTest
{
    public class Tests
    {
        ...
        public void Test1()
        {
            ...
            // ѕроверка, что количество случаев заражени€ не отрицательное число
        }
        ...
        public void Test3()
        {
            ...
            //  оличество стран на континенте - натуральное число
        }
        ...
        public void Test5()
        {
            ...
            // —реди стран присутствует јвстрали€
        }
    }
}